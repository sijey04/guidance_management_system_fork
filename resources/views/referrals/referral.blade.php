                ...
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col sm:flex-row gap-2">
                            ...
                            <!-- TEST: Simple Manage Reasons Button -->
                            <a href="{{ route('referral-reasons.index') }}" style="background-color: #1d4ed8 !important; color: white !important; padding: 8px 16px !important; border-radius: 8px !important; text-decoration: none !important; display: inline-flex !important; align-items: center !important; gap: 8px !important;">
                                <span>⚙️</span>
                                Manage Reasons
                            </a>
                            
                            <!-- Original Manage Reasons Button -->
                            <button onclick="window.location.href='{{ route('referral-reasons.index') }}'"
                                style="display: block !important; visibility: visible !important; opacity: 1 !important;"
                                class="bg-blue-600 text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-blue-700 transition shadow-sm hover:shadow-md flex items-center gap-2 w-full sm:w-auto justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
