...
$classes = ($active ?? false)
            ? 'inline-flex items-center py-3 px-5 border rounded bg-gray-600 dark:bg-gray-500 text-sm font-medium leading-5 text-white focus:outline-none focus:border-green-700 transition duration-150 ease-in-out'
